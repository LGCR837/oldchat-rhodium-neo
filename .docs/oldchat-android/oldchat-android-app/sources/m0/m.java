...
public abstract class m {
    ...
    public static boolean b(Context context, boolean z2, String str) {
        ...
        return context.getSharedPreferences("recent_fold", 0).getBoolean(a(z2, str), false);
    }
    ...
    public static void c(Context context, boolean z2, String str, boolean z3) {
        ...
        context.getSharedPreferences("recent_fold", 0).edit().putBoolean(a(z2, str), z3).apply();
    }
}
