...
public final class g {
    ...
    public final List f507a = new ArrayList();

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public final List f508b = new ArrayList();
    ...
    public final synchronized void b() {
        if (this.f507a.isEmpty()) {
            ...
            a(new int[]{30, 39}, "US");
            a(new int[]{60, CipherSuite.TLS_PSK_WITH_3DES_EDE_CBC_SHA}, "US/CA");
    ...
    public String c(String str) {
        ...
        for (int i4 = 0; i4 < size && i3 >= (i2 = (iArr = (int[]) this.f507a.get(i4))[0]); i4++) {
            if (iArr.length != 1) {
                i2 = iArr[1];
            }
            if (i3 <= i2) {
                return (String) this.f508b.get(i4);
            }
        }
        return null;
    }
