...
public class ARIAEngine implements BlockCipher {
    ...
    private static final byte[][] f7315C = {Hex.decode("517cc1b727220a94fe13abe8fa9a6ee0"), Hex.decode("6db14acc9e21c820ff28b1d5ef5de2b0"), Hex.decode("db92371d2126e9700324977504e8c90e")};
    ...
    public static byte[][] keySchedule(boolean z2, byte[] bArr) {
        ...
        int i4 = i3 * 2;
        int i5 = i4 + 12;
        byte[][] bArr12 = (byte[][]) Array.newInstance((Class<?>) Byte.TYPE, i4 + 13, 16);
    ...
    public static void keyScheduleRound(byte[] bArr, byte[] bArr2, byte[] bArr3, int i2) {
        int i3 = i2 >>> 3;
        int i4 = i2 & 7;
        int i5 = 8 - i4;
    ...
    public void init(boolean z2, CipherParameters cipherParameters) {
        if (cipherParameters instanceof KeyParameter) {
            this.roundKeys = keySchedule(z2, ((KeyParameter) cipherParameters).getKey());
            return;
        }
    ...
    public int processBlock(byte[] bArr, int i2, byte[] bArr2, int i3) {
        ...
        while (i4 < length) {
            int i5 = i4 + 1;
            FO(bArr3, this.roundKeys[i4]);
            i4 += 2;
            FE(bArr3, this.roundKeys[i5]);
        }
        FO(bArr3, this.roundKeys[i4]);
        xor(bArr3, this.roundKeys[i4 + 1]);
        SL2(bArr3);
        xor(bArr3, this.roundKeys[i4 + 2]);
