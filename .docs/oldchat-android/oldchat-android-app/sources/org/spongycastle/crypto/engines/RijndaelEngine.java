...
public class RijndaelEngine implements BlockCipher {
    ...
    private void InvMixColumn() {
        ...
        for (int i2 = 0; i2 < this.BC; i2 += 8) {
            ...
            jMul0xe |= ((long) ((((mul0xe(i8) ^ mul0xb(i9)) ^ mul0xd(i10)) ^ mul0x9(i7)) & 255)) << i2;
            jMul0xe2 |= ((long) ((((mul0xe(i9) ^ mul0xb(i10)) ^ mul0xd(i7)) ^ mul0x9(i8)) & 255)) << i2;
            jMul0xe3 |= ((long) ((((mul0xe(i10) ^ mul0xb(i7)) ^ mul0xd(i8)) ^ mul0x9(i9)) & 255)) << i2;
            jMul0xe4 = j2 | (((long) ((((mul0xe(i7) ^ mul0xb(i8)) ^ mul0xd(i9)) ^ mul0x9(i10)) & 255)) << i2);
        }
        this.A0 = jMul0xe;
        this.A1 = jMul0xe2;
        this.A2 = jMul0xe3;
    ...
    private void MixColumn() {
        ...
        for (int i2 = 0; i2 < this.BC; i2 += 8) {
            ...
            int i5 = (int) ((this.A2 >> i2) & 255);
            int i6 = (int) ((this.A3 >> i2) & 255);
            jMul0x2 |= ((long) ((((mul0x2(i3) ^ mul0x3(i4)) ^ i5) ^ i6) & 255)) << i2;
            jMul0x22 |= ((long) ((((mul0x2(i4) ^ mul0x3(i5)) ^ i6) ^ i3) & 255)) << i2;
            jMul0x23 |= ((long) ((((mul0x2(i5) ^ mul0x3(i6)) ^ i3) ^ i4) & 255)) << i2;
            jMul0x24 |= ((long) ((((mul0x2(i6) ^ mul0x3(i3)) ^ i4) ^ i5) & 255)) << i2;
        }
        this.A0 = jMul0x2;
        this.A1 = jMul0x22;
        this.A2 = jMul0x23;
    ...
    private long[][] generateWorkingKey(byte[] bArr) {
        ...
        int i8 = 0;
        int i9 = 0;
        while (i8 < i2 && i9 < (this.ROUNDS + 1) * (this.BC / 8)) {
            int i10 = 0;
            while (i10 < i5) {
                int i11 = this.BC;
        ...
        int i12 = 0;
        while (i9 < (this.ROUNDS + i4) * (this.BC / i3)) {
            int i13 = 0;
            for (int i14 = 4; i13 < i14; i14 = 4) {
                byte[] bArr3 = bArr2[i13];
                i13++;
                bArr3[0] = (byte) (f7331S[bArr2[i13 % 4][i2 - 1] & 255] ^ bArr3[0]);
            }
            byte[] bArr4 = bArr2[0];
            int i15 = i12 + 1;
            ...
            if (i2 <= 6) {
                ...
                for (int i22 = 0; i22 < i19; i22++) {
                    ...
                    bArr7[i19] = (byte) (bArr7[i19] ^ f7331S[bArr7[3] & 255]);
                }
                int i23 = 5;
                while (i23 < i2) {
                    int i24 = 0;
                    while (i24 < i19) {
                        byte[] bArr8 = bArr2[i24];
                        bArr8[i23] = (byte) (bArr8[i23] ^ bArr8[i23 - 1]);
                        i24++;
                        i19 = 4;
                    }
                    i23++;
            ...
            int i25 = 0;
            while (i25 < i2 && i9 < (this.ROUNDS + i4) * (this.BC / i3)) {
                for (int i26 = 0; i26 < 4; i26++) {
                    int i27 = this.BC;
                    long[] jArr3 = jArr[i9 / (i27 / 8)];
                    jArr3[i26] = (((long) (bArr2[i26][i25] & 255)) << ((i9 * 8) % i27)) | jArr3[i26];
                }
                i25++;
                i9++;
                i3 = 8;
    ...
    private void unpackBlock(byte[] bArr, int i2) {
        this.A0 = bArr[i2] & 255;
        this.A1 = bArr[i2 + 1] & 255;
        int i3 = i2 + 3;
        this.A2 = bArr[i2 + 2] & 255;
        int i4 = i2 + 4;
        this.A3 = bArr[i3] & 255;
        for (int i5 = 8; i5 != this.BC; i5 += 8) {
            this.A0 |= ((long) (bArr[i4] & 255)) << i5;
            this.A1 |= ((long) (bArr[i4 + 1] & 255)) << i5;
            int i6 = i4 + 3;
            this.A2 |= ((long) (bArr[i4 + 2] & 255)) << i5;
            i4 += 4;
            this.A3 |= ((long) (bArr[i6] & 255)) << i5;
        }
    }
