...
public class CamelliaEngine implements BlockCipher {
    ...
    private void camelliaF2(int[] iArr, int[] iArr2, int i2) {
        ...
        int i8 = iArr[1] ^ iArr2[i2 + 1];
        int i9 = (iArr5[(i8 >>> 24) & 255] ^ ((iArr6[i8 & 255] ^ iArr3[(i8 >>> 8) & 255]) ^ iArr4[(i8 >>> 16) & 255])) ^ i7;
        iArr[2] = iArr[2] ^ i9;
        int iRightRotate = (rightRotate(i7, 8) ^ i9) ^ iArr[3];
        iArr[3] = iRightRotate;
        int i10 = iArr[2] ^ iArr2[i2 + 2];
        int i11 = iArr6[(i10 >>> 24) & 255] ^ ((iArr3[i10 & 255] ^ iArr4[(i10 >>> 8) & 255]) ^ iArr5[(i10 >>> 16) & 255]);
        int i12 = iArr2[i2 + 3] ^ iRightRotate;
        int i13 = (iArr5[(i12 >>> 24) & 255] ^ ((iArr6[i12 & 255] ^ iArr3[(i12 >>> 8) & 255]) ^ iArr4[(i12 >>> 16) & 255])) ^ i11;
        iArr[0] = iArr[0] ^ i13;
        iArr[1] = (i13 ^ rightRotate(i11, 8)) ^ iArr[1];
    }

    private void camelliaFLs(int[] iArr, int[] iArr2, int i2) {
        int iLeftRotate = iArr[1] ^ leftRotate(iArr[0] & iArr2[i2], 1);
        iArr[1] = iLeftRotate;
    ...
    private static void decroldq(int i2, int[] iArr, int i3, int[] iArr2, int i4) {
        ...
        int i6 = i3 + 1;
        int i7 = 32 - i2;
        iArr2[i5] = (iArr[i3] << i2) | (iArr[i6] >>> i7);
        int i8 = i4 + 3;
        int i9 = i3 + 2;
        iArr2[i8] = (iArr[i6] << i2) | (iArr[i9] >>> i7);
        int i10 = i3 + 3;
        iArr2[i4] = (iArr[i9] << i2) | (iArr[i10] >>> i7);
        int i11 = i4 + 1;
        iArr2[i11] = (iArr[i10] << i2) | (iArr[i3] >>> i7);
        iArr[i3] = iArr2[i5];
        iArr[i6] = iArr2[i8];
        iArr[i9] = iArr2[i4];
        iArr[i10] = iArr2[i11];
    ...
    private static void decroldqo32(int i2, int[] iArr, int i3, int[] iArr2, int i4) {
        ...
        iArr2[i4] = (iArr[i11] << i7) | (iArr[i3] >>> i9);
        int i12 = i4 + 1;
        iArr2[i12] = (iArr[i6] >>> i9) | (iArr[i3] << i7);
        iArr[i3] = iArr2[i5];
        iArr[i6] = iArr2[i10];
        iArr[i8] = iArr2[i4];
        iArr[i11] = iArr2[i12];
    ...
    private static void roldq(int i2, int[] iArr, int i3, int[] iArr2, int i4) {
        int i5 = i3 + 1;
        int i6 = 32 - i2;
        iArr2[i4] = (iArr[i3] << i2) | (iArr[i5] >>> i6);
        int i7 = i4 + 1;
        int i8 = i3 + 2;
        iArr2[i7] = (iArr[i5] << i2) | (iArr[i8] >>> i6);
        int i9 = i4 + 2;
        int i10 = i3 + 3;
        iArr2[i9] = (iArr[i8] << i2) | (iArr[i10] >>> i6);
        int i11 = i4 + 3;
        iArr2[i11] = (iArr[i10] << i2) | (iArr[i3] >>> i6);
        iArr[i3] = iArr2[i4];
        iArr[i5] = iArr2[i7];
        iArr[i8] = iArr2[i9];
        iArr[i10] = iArr2[i11];
    ...
    private static void roldqo32(int i2, int[] iArr, int i3, int[] iArr2, int i4) {
        ...
        int i12 = i4 + 3;
        iArr2[i12] = (iArr[i5] >>> i8) | (iArr[i3] << i6);
        iArr[i3] = iArr2[i4];
        iArr[i5] = iArr2[i9];
        iArr[i7] = iArr2[i11];
        iArr[i10] = iArr2[i12];
