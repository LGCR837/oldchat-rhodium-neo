...
public final class SerpentEngine extends SerpentEngineBase {
    ...
    public void decryptBlock(byte[] bArr, int i2, byte[] bArr2, int i3) {
        this.X0 = this.wKey[128] ^ Pack.littleEndianToInt(bArr, i2);
        this.X1 = this.wKey[129] ^ Pack.littleEndianToInt(bArr, i2 + 4);
        this.X2 = this.wKey[130] ^ Pack.littleEndianToInt(bArr, i2 + 8);
        int iLittleEndianToInt = Pack.littleEndianToInt(bArr, i2 + 12) ^ this.wKey[131];
        this.X3 = iLittleEndianToInt;
        ib7(this.X0, this.X1, this.X2, iLittleEndianToInt);
        int i4 = this.X0;
        int[] iArr = this.wKey;
        this.X0 = i4 ^ iArr[124];
        this.X1 ^= iArr[125];
        ...
        this.X0 = i34 ^ iArr31[4];
        this.X1 ^= iArr31[5];
        this.X2 ^= iArr31[6];
        this.X3 ^= iArr31[7];
        inverseLT();
        ib0(this.X0, this.X1, this.X2, this.X3);
        Pack.intToLittleEndian(this.X0 ^ this.wKey[0], bArr2, i3);
        Pack.intToLittleEndian(this.X1 ^ this.wKey[1], bArr2, i3 + 4);
        Pack.intToLittleEndian(this.X2 ^ this.wKey[2], bArr2, i3 + 8);
        Pack.intToLittleEndian(this.X3 ^ this.wKey[3], bArr2, i3 + 12);
    }

    @Override // org.spongycastle.crypto.engines.SerpentEngineBase
    public void encryptBlock(byte[] bArr, int i2, byte[] bArr2, int i3) {
        this.X0 = Pack.littleEndianToInt(bArr, i2);
        this.X1 = Pack.littleEndianToInt(bArr, i2 + 4);
        this.X2 = Pack.littleEndianToInt(bArr, i2 + 8);
        int iLittleEndianToInt = Pack.littleEndianToInt(bArr, i2 + 12);
        this.X3 = iLittleEndianToInt;
        int[] iArr = this.wKey;
        sb0(iArr[0] ^ this.X0, iArr[1] ^ this.X1, iArr[2] ^ this.X2, iLittleEndianToInt ^ iArr[3]);
        LT();
        int[] iArr2 = this.wKey;
        ...
        Pack.intToLittleEndian(this.wKey[128] ^ this.X0, bArr2, i3);
        Pack.intToLittleEndian(this.wKey[129] ^ this.X1, bArr2, i3 + 4);
        Pack.intToLittleEndian(this.wKey[130] ^ this.X2, bArr2, i3 + 8);
        Pack.intToLittleEndian(this.wKey[131] ^ this.X3, bArr2, i3 + 12);
    }
    ...
    public int[] makeWorkingKey(byte[] bArr) {
        ...
        for (int i6 = 8; i6 < 16; i6++) {
            int i7 = i6 - 8;
            iArr[i6] = SerpentEngineBase.rotateLeft(((-1640531527) ^ (((iArr[i7] ^ iArr[i6 - 5]) ^ iArr[i6 - 3]) ^ iArr[i6 - 1])) ^ i7, 11);
        }
        System.arraycopy(iArr, 8, iArr2, 0, 8);
        for (int i8 = 8; i8 < 132; i8++) {
            iArr2[i8] = SerpentEngineBase.rotateLeft(((((iArr2[i8 - 8] ^ iArr2[i8 - 5]) ^ iArr2[i8 - 3]) ^ iArr2[i8 - 1]) ^ (-1640531527)) ^ i8, 11);
        }
