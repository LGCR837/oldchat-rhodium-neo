...
public final class TnepresEngine extends SerpentEngineBase {
    ...
    public void decryptBlock(byte[] bArr, int i2, byte[] bArr2, int i3) {
        this.X3 = this.wKey[131] ^ Pack.bigEndianToInt(bArr, i2);
        this.X2 = this.wKey[130] ^ Pack.bigEndianToInt(bArr, i2 + 4);
        this.X1 = this.wKey[129] ^ Pack.bigEndianToInt(bArr, i2 + 8);
        int iBigEndianToInt = Pack.bigEndianToInt(bArr, i2 + 12) ^ this.wKey[128];
        this.X0 = iBigEndianToInt;
        ib7(iBigEndianToInt, this.X1, this.X2, this.X3);
        int i4 = this.X0;
        int[] iArr = this.wKey;
        this.X0 = i4 ^ iArr[124];
        this.X1 ^= iArr[125];
        ...
        inverseLT();
        ib0(this.X0, this.X1, this.X2, this.X3);
        Pack.intToBigEndian(this.X3 ^ this.wKey[3], bArr2, i3);
        Pack.intToBigEndian(this.X2 ^ this.wKey[2], bArr2, i3 + 4);
        Pack.intToBigEndian(this.X1 ^ this.wKey[1], bArr2, i3 + 8);
        Pack.intToBigEndian(this.X0 ^ this.wKey[0], bArr2, i3 + 12);
    }

    @Override // org.spongycastle.crypto.engines.SerpentEngineBase
    public void encryptBlock(byte[] bArr, int i2, byte[] bArr2, int i3) {
        this.X3 = Pack.bigEndianToInt(bArr, i2);
        this.X2 = Pack.bigEndianToInt(bArr, i2 + 4);
        this.X1 = Pack.bigEndianToInt(bArr, i2 + 8);
        int iBigEndianToInt = Pack.bigEndianToInt(bArr, i2 + 12);
        this.X0 = iBigEndianToInt;
        int[] iArr = this.wKey;
        sb0(iBigEndianToInt ^ iArr[0], iArr[1] ^ this.X1, iArr[2] ^ this.X2, iArr[3] ^ this.X3);
        LT();
        int[] iArr2 = this.wKey;
        ...
        Pack.intToBigEndian(this.wKey[131] ^ this.X3, bArr2, i3);
        Pack.intToBigEndian(this.wKey[130] ^ this.X2, bArr2, i3 + 4);
        Pack.intToBigEndian(this.wKey[129] ^ this.X1, bArr2, i3 + 8);
        Pack.intToBigEndian(this.wKey[128] ^ this.X0, bArr2, i3 + 12);
    }
    ...
    public int[] makeWorkingKey(byte[] bArr) {
        ...
        int i3 = i2 + 1;
        iArr[i2] = Pack.bigEndianToInt(bArr, 0);
        if (i3 < 8) {
            iArr[i3] = 1;
        }
        ...
        for (int i4 = 8; i4 < 16; i4++) {
            int i5 = i4 - 8;
            iArr[i4] = SerpentEngineBase.rotateLeft(((-1640531527) ^ (((iArr[i5] ^ iArr[i4 - 5]) ^ iArr[i4 - 3]) ^ iArr[i4 - 1])) ^ i5, 11);
        }
