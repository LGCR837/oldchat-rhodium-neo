...
public class GOST28147Engine implements BlockCipher {
    ...
    private byte[] f7320S = Sbox_Default;
    ...
    private void GOST28147Func(int[] iArr, byte[] bArr, int i2, byte[] bArr2, int i3) {
        ...
        if (this.forEncryption) {
            for (int i7 = 0; i7 < 3; i7++) {
                int i8 = 0;
                while (i8 < 8) {
                    int iGOST28147_mainStep = iBytesToint2 ^ GOST28147_mainStep(iBytesToint, iArr[i8]);
                    i8++;
                    int i9 = iBytesToint;
            ...
            i5 = iBytesToint;
            while (i6 > 0) {
                int iGOST28147_mainStep2 = i4 ^ GOST28147_mainStep(i5, iArr[i6]);
                i6--;
                i4 = i5;
                i5 = iGOST28147_mainStep2;
            }
        } else {
            int i10 = 0;
            while (i10 < 8) {
                int iGOST28147_mainStep3 = iBytesToint2 ^ GOST28147_mainStep(iBytesToint, iArr[i10]);
                i10++;
                int i11 = iBytesToint;
            ...
            for (int i12 = 0; i12 < 3; i12++) {
                ...
                while (i13 >= 0 && (i12 != 2 || i13 != 0)) {
                    int iGOST28147_mainStep4 = i4 ^ GOST28147_mainStep(i5, iArr[i13]);
                    i13--;
                    i4 = i5;
                    i5 = iGOST28147_mainStep4;
                }
            }
        }
        int iGOST28147_mainStep5 = GOST28147_mainStep(i5, iArr[0]) ^ i4;
    ...
    private int GOST28147_mainStep(int i2, int i3) {
        int i4 = i3 + i2;
        byte[] bArr = this.f7320S;
        int i5 = bArr[i4 & 15] + (bArr[((i4 >> 4) & 15) + 16] << 4) + (bArr[((i4 >> 8) & 15) + 32] << 8) + (bArr[((i4 >> 12) & 15) + 48] << 12) + (bArr[((i4 >> 16) & 15) + 64] << Tnaf.POW_2_WIDTH) + (bArr[((i4 >> 20) & 15) + 80] << 20) + (bArr[((i4 >> 24) & 15) + 96] << 24) + (bArr[((i4 >> 28) & 15) + 112] << 28);
        return (i5 << 11) | (i5 >>> 21);
    }
