...
public class DTLSServerProtocol extends DTLSProtocol {
    ...
    public boolean expectCertificateVerifyMessage(ServerHandshakeState serverHandshakeState) {
        short s2 = serverHandshakeState.clientCertificateType;
    ...
    public void notifyClientCertificate(ServerHandshakeState serverHandshakeState, Certificate certificate) throws TlsFatalAlert {
    ...
    public void processCertificateVerify(ServerHandshakeState serverHandshakeState, byte[] bArr, TlsHandshakeHash tlsHandshakeHash) throws TlsFatalAlert {
        byte[] sessionHash;
        if (serverHandshakeState.certificateRequest == null) {
            throw new IllegalStateException();
        }
    ...
    public void processClientCertificate(ServerHandshakeState serverHandshakeState, byte[] bArr) throws TlsFatalAlert {
        ByteArrayInputStream byteArrayInputStream = new ByteArrayInputStream(bArr);
