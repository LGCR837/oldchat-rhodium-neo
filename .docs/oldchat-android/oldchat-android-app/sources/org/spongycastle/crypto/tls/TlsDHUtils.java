...
public class TlsDHUtils {
    ...
    public static byte[] createNegotiatedDHEGroupsClientExtension(short[] sArr) throws TlsFatalAlert {
    ...
    public static byte[] createNegotiatedDHEGroupsServerExtension(short s2) throws TlsFatalAlert {
    ...
    public static boolean isDHECipherSuite(int i2) {
        switch (i2) {
            case 17:
            case 18:
            case 19:
    ...
    public static short readNegotiatedDHEGroupsServerExtension(byte[] bArr) throws TlsFatalAlert {
        if (bArr == null) {
            throw new IllegalArgumentException("'extensionData' cannot be null");
        }
        if (bArr.length == 1) {
    ...
    public static DHParameters validateDHParameters(DHParameters dHParameters) throws TlsFatalAlert {
    ...
    public static DHPublicKeyParameters validateDHPublicKey(DHPublicKeyParameters dHPublicKeyParameters) throws TlsFatalAlert {
        ...
        BigInteger bigInteger = TWO;
        if (y2.compareTo(bigInteger) < 0 || y2.compareTo(dHParametersValidateDHParameters.getP().subtract(bigInteger)) > 0) {
            throw new TlsFatalAlert((short) 47);
        }
