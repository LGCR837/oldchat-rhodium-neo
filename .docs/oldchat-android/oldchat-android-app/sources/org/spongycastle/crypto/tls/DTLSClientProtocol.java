...
public class DTLSClientProtocol extends DTLSProtocol {
    ...
    public static byte[] patchClientHelloWithCookie(byte[] bArr, byte[] bArr2) throws TlsFatalAlert {
    ...
    public DTLSTransport connect(TlsClient tlsClient, DatagramTransport datagramTransport) {
        ...
        try {
            try {
                ...
                abortClientHandshake(clientHandshakeState, dTLSRecordLayer, e4.getAlertDescription());
                throw e4;
            }
        } finally {
    ...
    public void processCertificateRequest(ClientHandshakeState clientHandshakeState, byte[] bArr) throws TlsFatalAlert {
    ...
    public void processCertificateStatus(ClientHandshakeState clientHandshakeState, byte[] bArr) throws TlsFatalAlert {
    ...
    public void reportServerVersion(ClientHandshakeState clientHandshakeState, ProtocolVersion protocolVersion) throws TlsFatalAlert {
        TlsClientContextImpl tlsClientContextImpl = clientHandshakeState.clientContext;
