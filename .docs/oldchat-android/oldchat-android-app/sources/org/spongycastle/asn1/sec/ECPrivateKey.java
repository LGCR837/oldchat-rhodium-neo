...
public class ECPrivateKey extends ASN1Object {
    ...
    private ASN1Primitive getObjectInTag(int i2) {
    ...
    public ECPrivateKey(int i2, BigInteger bigInteger) {
        byte[] bArrAsUnsignedByteArray = BigIntegers.asUnsignedByteArray((i2 + 7) / 8, bigInteger);
    ...
    public ECPrivateKey(int i2, BigInteger bigInteger, ASN1Encodable aSN1Encodable) {
        this(i2, bigInteger, null, aSN1Encodable);
    }

    public ECPrivateKey(int i2, BigInteger bigInteger, DERBitString dERBitString, ASN1Encodable aSN1Encodable) {
        byte[] bArrAsUnsignedByteArray = BigIntegers.asUnsignedByteArray((i2 + 7) / 8, bigInteger);
        ASN1EncodableVector aSN1EncodableVector = new ASN1EncodableVector();
        aSN1EncodableVector.add(new ASN1Integer(1L));
        aSN1EncodableVector.add(new DEROctetString(bArrAsUnsignedByteArray));
