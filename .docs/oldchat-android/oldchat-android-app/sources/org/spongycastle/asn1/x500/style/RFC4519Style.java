...
public class RFC4519Style extends AbstractX500NameStyle {
    ...
    public static final ASN1ObjectIdentifier f7211c;
    ...
    public static final ASN1ObjectIdentifier f7212l;
    public static final ASN1ObjectIdentifier member;
    public static final ASN1ObjectIdentifier name;

    /* JADX INFO: renamed from: o, reason: collision with root package name */
    public static final ASN1ObjectIdentifier f7213o;
    ...
    static {
        ...
        f7211c = aSN1ObjectIdentifierIntern2;
        ...
        f7212l = aSN1ObjectIdentifierIntern16;
        ...
        f7213o = aSN1ObjectIdentifierIntern19;
    ...
    public ASN1Encodable encodeStringValue(ASN1ObjectIdentifier aSN1ObjectIdentifier, String str) {
        return aSN1ObjectIdentifier.equals(dc) ? new DERIA5String(str) : (aSN1ObjectIdentifier.equals(f7211c) || aSN1ObjectIdentifier.equals(serialNumber) || aSN1ObjectIdentifier.equals(dnQualifier) || aSN1ObjectIdentifier.equals(telephoneNumber)) ? new DERPrintableString(str) : super.encodeStringValue(aSN1ObjectIdentifier, str);
    }
    ...
    public RDN[] fromString(String str) {
        ...
        for (int i2 = 0; i2 != rdnArrRDNsFromString.length; i2++) {
            rdnArr[(r0 - i2) - 1] = rdnArrRDNsFromString[i2];
        }
        return rdnArr;
    }
