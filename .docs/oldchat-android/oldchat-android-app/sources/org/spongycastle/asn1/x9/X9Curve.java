...
public class X9Curve extends ASN1Object implements X9ObjectIdentifiers {
    ...
    public X9Curve(X9FieldID x9FieldID, ASN1Sequence aSN1Sequence) {
        ...
        if (identifier.equals(X9ObjectIdentifiers.prime_field)) {
            ...
            int i4 = i2;
            int i5 = iIntValue;
            this.curve = new ECCurve.F2m(iIntValue3, i3, i4, i5, new X9FieldElement(iIntValue3, i3, i4, i5, (ASN1OctetString) aSN1Sequence.getObjectAt(0)).getValue().toBigInteger(), new X9FieldElement(iIntValue3, i3, i4, i5, (ASN1OctetString) aSN1Sequence.getObjectAt(1)).getValue().toBigInteger());
        } else {
            throw new IllegalArgumentException("This type of ECCurve is not implemented");
        }
