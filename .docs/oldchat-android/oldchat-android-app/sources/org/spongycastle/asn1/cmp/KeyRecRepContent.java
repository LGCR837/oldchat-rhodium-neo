...
public class KeyRecRepContent extends ASN1Object {
    ...
    public CMPCertificate[] getCaCerts() {
        ...
        for (int i2 = 0; i2 != size; i2++) {
            cMPCertificateArr[i2] = CMPCertificate.getInstance(this.caCerts.getObjectAt(i2));
        }
    ...
    public CertifiedKeyPair[] getKeyPairHist() {
        ...
        for (int i2 = 0; i2 != size; i2++) {
            certifiedKeyPairArr[i2] = CertifiedKeyPair.getInstance(this.keyPairHist.getObjectAt(i2));
        }
