...
public class RevRepContent extends ASN1Object {
    ...
    public CertificateList[] getCrls() {
        ...
        for (int i2 = 0; i2 != size; i2++) {
            certificateListArr[i2] = CertificateList.getInstance(this.crls.getObjectAt(i2));
        }
    ...
    public CertId[] getRevCerts() {
        ...
        for (int i2 = 0; i2 != size; i2++) {
            certIdArr[i2] = CertId.getInstance(this.revCerts.getObjectAt(i2));
        }
        return certIdArr;
    }
    ...
    public PKIStatusInfo[] getStatus() {
        ...
        for (int i2 = 0; i2 != size; i2++) {
            pKIStatusInfoArr[i2] = PKIStatusInfo.getInstance(this.status.getObjectAt(i2));
        }
