...
public class EnvelopedData extends ASN1Object {
    ...
    public static EnvelopedData getInstance(ASN1TaggedObject aSN1TaggedObject, boolean z2) {
    ...
    public EnvelopedData(ASN1Sequence aSN1Sequence) {
        ...
        if (aSN1Sequence.size() > i3) {
            this.unprotectedAttrs = ASN1Set.getInstance((ASN1TaggedObject) aSN1Sequence.getObjectAt(i3), false);
        }
    }
}
