...
public class KeyAgreeRecipientInfo extends ASN1Object {
    ...
    public static KeyAgreeRecipientInfo getInstance(ASN1TaggedObject aSN1TaggedObject, boolean z2) {
    ...
    public KeyAgreeRecipientInfo(ASN1Sequence aSN1Sequence) {
        ...
        this.keyEncryptionAlgorithm = AlgorithmIdentifier.getInstance(aSN1Sequence.getObjectAt(i2));
        this.recipientEncryptedKeys = (ASN1Sequence) aSN1Sequence.getObjectAt(i2 + 1);
    }
}
