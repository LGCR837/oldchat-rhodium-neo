...
public class AuthEnvelopedData extends ASN1Object {
    ...
    public static AuthEnvelopedData getInstance(ASN1TaggedObject aSN1TaggedObject, boolean z2) {
    ...
    private AuthEnvelopedData(ASN1Sequence aSN1Sequence) {
        ...
        if (aSN1Integer.getValue().intValue() == 0) {
            ...
            if (aSN1Set2.size() != 0) {
                this.authEncryptedContentInfo = EncryptedContentInfo.getInstance(aSN1Sequence.getObjectAt(i2).toASN1Primitive());
                int i3 = i2 + 2;
                ASN1Primitive aSN1Primitive2 = aSN1Sequence.getObjectAt(i2 + 1).toASN1Primitive();
