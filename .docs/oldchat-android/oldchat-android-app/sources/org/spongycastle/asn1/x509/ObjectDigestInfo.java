...
public class ObjectDigestInfo extends ASN1Object {
    ...
    public ObjectDigestInfo(int i2, ASN1ObjectIdentifier aSN1ObjectIdentifier, AlgorithmIdentifier algorithmIdentifier, byte[] bArr) {
        this.digestedObjectType = new ASN1Enumerated(i2);
        if (i2 == 2) {
    ...
    public static ObjectDigestInfo getInstance(ASN1TaggedObject aSN1TaggedObject, boolean z2) {
    ...
    private ObjectDigestInfo(ASN1Sequence aSN1Sequence) {
        if (aSN1Sequence.size() <= 4 && aSN1Sequence.size() >= 3) {
            ...
            this.digestAlgorithm = AlgorithmIdentifier.getInstance(aSN1Sequence.getObjectAt(i2 + 1));
            this.objectDigest = DERBitString.getInstance(aSN1Sequence.getObjectAt(i2 + 2));
            return;
        }
