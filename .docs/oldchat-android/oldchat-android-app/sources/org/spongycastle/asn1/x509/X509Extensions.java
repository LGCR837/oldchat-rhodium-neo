...
public class X509Extensions extends ASN1Object {
    ...
    private ASN1ObjectIdentifier[] getExtensionOIDs(boolean z2) {
        ...
        for (int i2 = 0; i2 != this.ordering.size(); i2++) {
            Object objElementAt = this.ordering.elementAt(i2);
            if (((X509Extension) this.extensions.get(objElementAt)).isCritical() == z2) {
    ...
    public X509Extensions(Vector vector, Vector vector2) {
        ...
        int i2 = 0;
        while (enumerationElements2.hasMoreElements()) {
            this.extensions.put((ASN1ObjectIdentifier) enumerationElements2.nextElement(), (X509Extension) vector2.elementAt(i2));
            i2++;
        }
    }
}
