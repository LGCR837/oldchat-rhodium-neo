...
public class TBSCertList extends ASN1Object {
    ...
    public TBSCertList(ASN1Sequence aSN1Sequence) {
        ...
        this.issuer = X500Name.getInstance(aSN1Sequence.getObjectAt(i2 + 1));
        int i3 = i2 + 3;
        this.thisUpdate = Time.getInstance(aSN1Sequence.getObjectAt(i2 + 2));
        if (i3 < aSN1Sequence.size() && ((aSN1Sequence.getObjectAt(i3) instanceof ASN1UTCTime) || (aSN1Sequence.getObjectAt(i3) instanceof ASN1GeneralizedTime) || (aSN1Sequence.getObjectAt(i3) instanceof Time))) {
            this.nextUpdate = Time.getInstance(aSN1Sequence.getObjectAt(i3));
            i3 = i2 + 4;
        }
        if (i3 < aSN1Sequence.size() && !(aSN1Sequence.getObjectAt(i3) instanceof ASN1TaggedObject)) {
            this.revokedCertificates = ASN1Sequence.getInstance(aSN1Sequence.getObjectAt(i3));
            i3++;
        }
        if (i3 >= aSN1Sequence.size() || !(aSN1Sequence.getObjectAt(i3) instanceof ASN1TaggedObject)) {
            return;
        }
        this.crlExtensions = Extensions.getInstance(ASN1Sequence.getInstance((ASN1TaggedObject) aSN1Sequence.getObjectAt(i3), true));
    }
