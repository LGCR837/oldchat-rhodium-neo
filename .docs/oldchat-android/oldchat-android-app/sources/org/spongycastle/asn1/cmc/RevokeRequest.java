...
public class RevokeRequest extends ASN1Object {
    ...
    private RevokeRequest(ASN1Sequence aSN1Sequence) {
        ...
        if (aSN1Sequence.size() >= 3 && aSN1Sequence.size() <= 6) {
            ...
            if (aSN1Sequence.size() > i2 && (aSN1Sequence.getObjectAt(i2).toASN1Primitive() instanceof ASN1OctetString)) {
                this.passphrase = ASN1OctetString.getInstance(aSN1Sequence.getObjectAt(i2));
                i2++;
            }
            if (aSN1Sequence.size() <= i2 || !(aSN1Sequence.getObjectAt(i2).toASN1Primitive() instanceof DERUTF8String)) {
                return;
            }
            this.comment = DERUTF8String.getInstance(aSN1Sequence.getObjectAt(i2));
            return;
        }
