...
public class SecT409R1Curve extends ECCurve.AbstractF2m {
    ...
    public SecT409R1Curve() {
        ...
        this.f7496a = fromBigInteger(BigInteger.valueOf(1L));
        this.f7497b = fromBigInteger(new BigInteger(1, Hex.decode("0021A5C2C8EE9FEB5C4B9A753B7B476B7FD6422EF1F3DD674761FA99D6AC27C8A9A197B272822F6CD57A55AA4F50AE317B13545F")));
    ...
    public ECPoint createRawPoint(ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, boolean z2) {
        return new SecT409R1Point(this, eCFieldElement, eCFieldElement2, z2);
    }
    ...
    public ECPoint createRawPoint(ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement[] eCFieldElementArr, boolean z2) {
        return new SecT409R1Point(this, eCFieldElement, eCFieldElement2, eCFieldElementArr, z2);
    }
}
