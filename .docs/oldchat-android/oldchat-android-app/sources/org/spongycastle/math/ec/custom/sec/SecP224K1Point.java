...
public class SecP224K1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecP224K1FieldElement secP224K1FieldElement = (SecP224K1FieldElement) this.f7506x;
        SecP224K1FieldElement secP224K1FieldElement2 = (SecP224K1FieldElement) this.f7507y;
        ...
        if (zIsOne) {
            iArr = secP224K1FieldElement3.f7547x;
            iArr2 = secP224K1FieldElement4.f7547x;
        } else {
            SecP224K1Field.square(secP224K1FieldElement5.f7547x, iArrCreate2);
            SecP224K1Field.multiply(iArrCreate2, secP224K1FieldElement3.f7547x, iArrCreate);
            SecP224K1Field.multiply(iArrCreate2, secP224K1FieldElement5.f7547x, iArrCreate2);
            SecP224K1Field.multiply(iArrCreate2, secP224K1FieldElement4.f7547x, iArrCreate2);
            iArr = iArrCreate;
            iArr2 = iArrCreate2;
        }
        boolean zIsOne2 = secP224K1FieldElement6.isOne();
        if (zIsOne2) {
            iArr3 = secP224K1FieldElement.f7547x;
            iArr4 = secP224K1FieldElement2.f7547x;
        } else {
            SecP224K1Field.square(secP224K1FieldElement6.f7547x, iArrCreate3);
            SecP224K1Field.multiply(iArrCreate3, secP224K1FieldElement.f7547x, iArrCreateExt);
            SecP224K1Field.multiply(iArrCreate3, secP224K1FieldElement6.f7547x, iArrCreate3);
            SecP224K1Field.multiply(iArrCreate3, secP224K1FieldElement2.f7547x, iArrCreate3);
            iArr3 = iArrCreateExt;
            iArr4 = iArrCreate3;
        }
        ...
        SecP224K1Field.square(iArrCreate, secP224K1FieldElement7.f7547x);
        int[] iArr5 = secP224K1FieldElement7.f7547x;
        ...
        SecP224K1Field.subtract(iArrCreate2, secP224K1FieldElement7.f7547x, secP224K1FieldElement8.f7547x);
        SecP224K1Field.multiplyAddToExt(secP224K1FieldElement8.f7547x, iArrCreate, iArrCreateExt);
        SecP224K1Field.reduce(iArrCreateExt, secP224K1FieldElement8.f7547x);
        SecP224K1FieldElement secP224K1FieldElement9 = new SecP224K1FieldElement(iArrCreate4);
        if (!zIsOne) {
            int[] iArr6 = secP224K1FieldElement9.f7547x;
            SecP224K1Field.multiply(iArr6, secP224K1FieldElement5.f7547x, iArr6);
        }
        if (!zIsOne2) {
            int[] iArr7 = secP224K1FieldElement9.f7547x;
            SecP224K1Field.multiply(iArr7, secP224K1FieldElement6.f7547x, iArr7);
        }
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP224K1Point(this.curve, this.f7506x, this.f7507y.negate(), this.zs, this.withCompression);
    }
    ...
    public ECPoint twice() {
        ...
        ECCurve curve = getCurve();
        SecP224K1FieldElement secP224K1FieldElement = (SecP224K1FieldElement) this.f7507y;
        if (secP224K1FieldElement.isZero()) {
            return curve.getInfinity();
        }
        SecP224K1FieldElement secP224K1FieldElement2 = (SecP224K1FieldElement) this.f7506x;
        SecP224K1FieldElement secP224K1FieldElement3 = (SecP224K1FieldElement) this.zs[0];
        int[] iArrCreate = Nat224.create();
        SecP224K1Field.square(secP224K1FieldElement.f7547x, iArrCreate);
        int[] iArrCreate2 = Nat224.create();
        SecP224K1Field.square(iArrCreate, iArrCreate2);
        int[] iArrCreate3 = Nat224.create();
        SecP224K1Field.square(secP224K1FieldElement2.f7547x, iArrCreate3);
        SecP224K1Field.reduce32(Nat224.addBothTo(iArrCreate3, iArrCreate3, iArrCreate3), iArrCreate3);
        SecP224K1Field.multiply(iArrCreate, secP224K1FieldElement2.f7547x, iArrCreate);
        ...
        SecP224K1Field.square(iArrCreate3, secP224K1FieldElement4.f7547x);
        int[] iArr = secP224K1FieldElement4.f7547x;
        SecP224K1Field.subtract(iArr, iArrCreate, iArr);
        int[] iArr2 = secP224K1FieldElement4.f7547x;
        ...
        SecP224K1Field.subtract(iArrCreate, secP224K1FieldElement4.f7547x, secP224K1FieldElement5.f7547x);
        int[] iArr3 = secP224K1FieldElement5.f7547x;
        SecP224K1Field.multiply(iArr3, iArrCreate3, iArr3);
        int[] iArr4 = secP224K1FieldElement5.f7547x;
        ...
        SecP224K1Field.twice(secP224K1FieldElement.f7547x, secP224K1FieldElement6.f7547x);
        if (!secP224K1FieldElement3.isOne()) {
            int[] iArr5 = secP224K1FieldElement6.f7547x;
            SecP224K1Field.multiply(iArr5, secP224K1FieldElement3.f7547x, iArr5);
        }
    ...
    public SecP224K1Point(ECCurve eCCurve, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement[] eCFieldElementArr, boolean z2) {
