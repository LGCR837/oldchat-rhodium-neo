...
public class SecP521R1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecP521R1FieldElement secP521R1FieldElement = (SecP521R1FieldElement) this.f7506x;
        SecP521R1FieldElement secP521R1FieldElement2 = (SecP521R1FieldElement) this.f7507y;
        ...
        if (zIsOne) {
            iArr = secP521R1FieldElement3.f7570x;
            iArr2 = secP521R1FieldElement4.f7570x;
        } else {
            SecP521R1Field.square(secP521R1FieldElement5.f7570x, iArrCreate3);
            SecP521R1Field.multiply(iArrCreate3, secP521R1FieldElement3.f7570x, iArrCreate2);
            SecP521R1Field.multiply(iArrCreate3, secP521R1FieldElement5.f7570x, iArrCreate3);
            SecP521R1Field.multiply(iArrCreate3, secP521R1FieldElement4.f7570x, iArrCreate3);
            iArr = iArrCreate2;
            iArr2 = iArrCreate3;
        }
        boolean zIsOne2 = secP521R1FieldElement6.isOne();
        if (zIsOne2) {
            iArr3 = secP521R1FieldElement.f7570x;
            iArr4 = secP521R1FieldElement2.f7570x;
        } else {
            SecP521R1Field.square(secP521R1FieldElement6.f7570x, iArrCreate4);
            SecP521R1Field.multiply(iArrCreate4, secP521R1FieldElement.f7570x, iArrCreate);
            SecP521R1Field.multiply(iArrCreate4, secP521R1FieldElement6.f7570x, iArrCreate4);
            SecP521R1Field.multiply(iArrCreate4, secP521R1FieldElement2.f7570x, iArrCreate4);
            iArr3 = iArrCreate;
            iArr4 = iArrCreate4;
        }
        ...
        SecP521R1Field.square(iArrCreate2, secP521R1FieldElement7.f7570x);
        int[] iArr5 = secP521R1FieldElement7.f7570x;
        SecP521R1Field.add(iArr5, iArrCreate6, iArr5);
        int[] iArr6 = secP521R1FieldElement7.f7570x;
        SecP521R1Field.subtract(iArr6, iArrCreate3, iArr6);
        int[] iArr7 = secP521R1FieldElement7.f7570x;
        ...
        SecP521R1Field.subtract(iArrCreate3, secP521R1FieldElement7.f7570x, secP521R1FieldElement8.f7570x);
        SecP521R1Field.multiply(secP521R1FieldElement8.f7570x, iArrCreate2, iArrCreate2);
        SecP521R1Field.subtract(iArrCreate2, iArrCreate, secP521R1FieldElement8.f7570x);
        SecP521R1FieldElement secP521R1FieldElement9 = new SecP521R1FieldElement(iArrCreate5);
        if (!zIsOne) {
            int[] iArr8 = secP521R1FieldElement9.f7570x;
            SecP521R1Field.multiply(iArr8, secP521R1FieldElement5.f7570x, iArr8);
        }
        if (!zIsOne2) {
            int[] iArr9 = secP521R1FieldElement9.f7570x;
            SecP521R1Field.multiply(iArr9, secP521R1FieldElement6.f7570x, iArr9);
        }
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP521R1Point(this.curve, this.f7506x, this.f7507y.negate(), this.zs, this.withCompression);
    }
    ...
    public ECPoint twice() {
        ...
        ECCurve curve = getCurve();
        SecP521R1FieldElement secP521R1FieldElement = (SecP521R1FieldElement) this.f7507y;
        if (secP521R1FieldElement.isZero()) {
            return curve.getInfinity();
        }
        SecP521R1FieldElement secP521R1FieldElement2 = (SecP521R1FieldElement) this.f7506x;
        SecP521R1FieldElement secP521R1FieldElement3 = (SecP521R1FieldElement) this.zs[0];
        int[] iArrCreate = Nat.create(17);
        int[] iArrCreate2 = Nat.create(17);
        int[] iArrCreate3 = Nat.create(17);
        SecP521R1Field.square(secP521R1FieldElement.f7570x, iArrCreate3);
        int[] iArrCreate4 = Nat.create(17);
        SecP521R1Field.square(iArrCreate3, iArrCreate4);
        boolean zIsOne = secP521R1FieldElement3.isOne();
        int[] iArr = secP521R1FieldElement3.f7570x;
        if (!zIsOne) {
            SecP521R1Field.square(iArr, iArrCreate2);
            iArr = iArrCreate2;
        }
        SecP521R1Field.subtract(secP521R1FieldElement2.f7570x, iArr, iArrCreate);
        SecP521R1Field.add(secP521R1FieldElement2.f7570x, iArr, iArrCreate2);
        ...
        SecP521R1Field.multiply(iArrCreate3, secP521R1FieldElement2.f7570x, iArrCreate3);
        ...
        SecP521R1Field.square(iArrCreate2, secP521R1FieldElement4.f7570x);
        int[] iArr2 = secP521R1FieldElement4.f7570x;
        SecP521R1Field.subtract(iArr2, iArrCreate3, iArr2);
        int[] iArr3 = secP521R1FieldElement4.f7570x;
        ...
        SecP521R1Field.subtract(iArrCreate3, secP521R1FieldElement4.f7570x, secP521R1FieldElement5.f7570x);
        int[] iArr4 = secP521R1FieldElement5.f7570x;
        SecP521R1Field.multiply(iArr4, iArrCreate2, iArr4);
        int[] iArr5 = secP521R1FieldElement5.f7570x;
        ...
        SecP521R1Field.twice(secP521R1FieldElement.f7570x, secP521R1FieldElement6.f7570x);
        if (!zIsOne) {
            int[] iArr6 = secP521R1FieldElement6.f7570x;
            SecP521R1Field.multiply(iArr6, secP521R1FieldElement3.f7570x, iArr6);
        }
    ...
    public SecP521R1Point(ECCurve eCCurve, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement[] eCFieldElementArr, boolean z2) {
