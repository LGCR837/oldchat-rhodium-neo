...
public class SecT163K1Curve extends ECCurve.AbstractF2m {
    ...
    public SecT163K1Curve() {
        ...
        this.f7496a = eCFieldElementFromBigInteger;
        this.f7497b = eCFieldElementFromBigInteger;
    ...
    public ECPoint createRawPoint(ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, boolean z2) {
        return new SecT163K1Point(this, eCFieldElement, eCFieldElement2, z2);
    }
    ...
    public ECPoint createRawPoint(ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement[] eCFieldElementArr, boolean z2) {
        return new SecT163K1Point(this, eCFieldElement, eCFieldElement2, eCFieldElementArr, z2);
    }
}
