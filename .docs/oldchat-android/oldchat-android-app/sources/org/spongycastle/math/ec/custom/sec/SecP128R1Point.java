...
public class SecP128R1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecP128R1FieldElement secP128R1FieldElement = (SecP128R1FieldElement) this.f7506x;
        SecP128R1FieldElement secP128R1FieldElement2 = (SecP128R1FieldElement) this.f7507y;
        ...
        if (zIsOne) {
            iArr = secP128R1FieldElement3.f7524x;
            iArr2 = secP128R1FieldElement4.f7524x;
        } else {
            SecP128R1Field.square(secP128R1FieldElement5.f7524x, iArrCreate2);
            SecP128R1Field.multiply(iArrCreate2, secP128R1FieldElement3.f7524x, iArrCreate);
            SecP128R1Field.multiply(iArrCreate2, secP128R1FieldElement5.f7524x, iArrCreate2);
            SecP128R1Field.multiply(iArrCreate2, secP128R1FieldElement4.f7524x, iArrCreate2);
            iArr = iArrCreate;
            iArr2 = iArrCreate2;
        }
        boolean zIsOne2 = secP128R1FieldElement6.isOne();
        if (zIsOne2) {
            iArr3 = secP128R1FieldElement.f7524x;
            iArr4 = secP128R1FieldElement2.f7524x;
        } else {
            SecP128R1Field.square(secP128R1FieldElement6.f7524x, iArrCreate3);
            SecP128R1Field.multiply(iArrCreate3, secP128R1FieldElement.f7524x, iArrCreateExt);
            SecP128R1Field.multiply(iArrCreate3, secP128R1FieldElement6.f7524x, iArrCreate3);
            SecP128R1Field.multiply(iArrCreate3, secP128R1FieldElement2.f7524x, iArrCreate3);
            iArr3 = iArrCreateExt;
            iArr4 = iArrCreate3;
        }
        ...
        SecP128R1Field.square(iArrCreate, secP128R1FieldElement7.f7524x);
        int[] iArr5 = secP128R1FieldElement7.f7524x;
        ...
        SecP128R1Field.subtract(iArrCreate2, secP128R1FieldElement7.f7524x, secP128R1FieldElement8.f7524x);
        SecP128R1Field.multiplyAddToExt(secP128R1FieldElement8.f7524x, iArrCreate, iArrCreateExt);
        SecP128R1Field.reduce(iArrCreateExt, secP128R1FieldElement8.f7524x);
        SecP128R1FieldElement secP128R1FieldElement9 = new SecP128R1FieldElement(iArrCreate4);
        if (!zIsOne) {
            int[] iArr6 = secP128R1FieldElement9.f7524x;
            SecP128R1Field.multiply(iArr6, secP128R1FieldElement5.f7524x, iArr6);
        }
        if (!zIsOne2) {
            int[] iArr7 = secP128R1FieldElement9.f7524x;
            SecP128R1Field.multiply(iArr7, secP128R1FieldElement6.f7524x, iArr7);
        }
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP128R1Point(this.curve, this.f7506x, this.f7507y.negate(), this.zs, this.withCompression);
    }
    ...
    public ECPoint twice() {
        ...
        ECCurve curve = getCurve();
        SecP128R1FieldElement secP128R1FieldElement = (SecP128R1FieldElement) this.f7507y;
        if (secP128R1FieldElement.isZero()) {
            return curve.getInfinity();
        }
        SecP128R1FieldElement secP128R1FieldElement2 = (SecP128R1FieldElement) this.f7506x;
        SecP128R1FieldElement secP128R1FieldElement3 = (SecP128R1FieldElement) this.zs[0];
        int[] iArrCreate = Nat128.create();
        int[] iArrCreate2 = Nat128.create();
        int[] iArrCreate3 = Nat128.create();
        SecP128R1Field.square(secP128R1FieldElement.f7524x, iArrCreate3);
        int[] iArrCreate4 = Nat128.create();
        SecP128R1Field.square(iArrCreate3, iArrCreate4);
        boolean zIsOne = secP128R1FieldElement3.isOne();
        int[] iArr = secP128R1FieldElement3.f7524x;
        if (!zIsOne) {
            SecP128R1Field.square(iArr, iArrCreate2);
            iArr = iArrCreate2;
        }
        SecP128R1Field.subtract(secP128R1FieldElement2.f7524x, iArr, iArrCreate);
        SecP128R1Field.add(secP128R1FieldElement2.f7524x, iArr, iArrCreate2);
        ...
        SecP128R1Field.square(iArrCreate2, secP128R1FieldElement4.f7524x);
        int[] iArr2 = secP128R1FieldElement4.f7524x;
        SecP128R1Field.subtract(iArr2, iArrCreate3, iArr2);
        int[] iArr3 = secP128R1FieldElement4.f7524x;
        ...
        SecP128R1Field.subtract(iArrCreate3, secP128R1FieldElement4.f7524x, secP128R1FieldElement5.f7524x);
        int[] iArr4 = secP128R1FieldElement5.f7524x;
        SecP128R1Field.multiply(iArr4, iArrCreate2, iArr4);
        int[] iArr5 = secP128R1FieldElement5.f7524x;
        ...
        SecP128R1Field.twice(secP128R1FieldElement.f7524x, secP128R1FieldElement6.f7524x);
        if (!zIsOne) {
            int[] iArr6 = secP128R1FieldElement6.f7524x;
            SecP128R1Field.multiply(iArr6, secP128R1FieldElement3.f7524x, iArr6);
        }
