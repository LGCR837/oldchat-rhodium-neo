...
public class SecP192R1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecP192R1FieldElement secP192R1FieldElement = (SecP192R1FieldElement) this.f7506x;
        SecP192R1FieldElement secP192R1FieldElement2 = (SecP192R1FieldElement) this.f7507y;
        ...
        if (zIsOne) {
            iArr = secP192R1FieldElement3.f7543x;
            iArr2 = secP192R1FieldElement4.f7543x;
        } else {
            SecP192R1Field.square(secP192R1FieldElement5.f7543x, iArrCreate2);
            SecP192R1Field.multiply(iArrCreate2, secP192R1FieldElement3.f7543x, iArrCreate);
            SecP192R1Field.multiply(iArrCreate2, secP192R1FieldElement5.f7543x, iArrCreate2);
            SecP192R1Field.multiply(iArrCreate2, secP192R1FieldElement4.f7543x, iArrCreate2);
            iArr = iArrCreate;
            iArr2 = iArrCreate2;
        }
        boolean zIsOne2 = secP192R1FieldElement6.isOne();
        if (zIsOne2) {
            iArr3 = secP192R1FieldElement.f7543x;
            iArr4 = secP192R1FieldElement2.f7543x;
        } else {
            SecP192R1Field.square(secP192R1FieldElement6.f7543x, iArrCreate3);
            SecP192R1Field.multiply(iArrCreate3, secP192R1FieldElement.f7543x, iArrCreateExt);
            SecP192R1Field.multiply(iArrCreate3, secP192R1FieldElement6.f7543x, iArrCreate3);
            SecP192R1Field.multiply(iArrCreate3, secP192R1FieldElement2.f7543x, iArrCreate3);
            iArr3 = iArrCreateExt;
            iArr4 = iArrCreate3;
        }
        ...
        SecP192R1Field.square(iArrCreate, secP192R1FieldElement7.f7543x);
        int[] iArr5 = secP192R1FieldElement7.f7543x;
        ...
        SecP192R1Field.subtract(iArrCreate2, secP192R1FieldElement7.f7543x, secP192R1FieldElement8.f7543x);
        SecP192R1Field.multiplyAddToExt(secP192R1FieldElement8.f7543x, iArrCreate, iArrCreateExt);
        SecP192R1Field.reduce(iArrCreateExt, secP192R1FieldElement8.f7543x);
        SecP192R1FieldElement secP192R1FieldElement9 = new SecP192R1FieldElement(iArrCreate4);
        if (!zIsOne) {
            int[] iArr6 = secP192R1FieldElement9.f7543x;
            SecP192R1Field.multiply(iArr6, secP192R1FieldElement5.f7543x, iArr6);
        }
        if (!zIsOne2) {
            int[] iArr7 = secP192R1FieldElement9.f7543x;
            SecP192R1Field.multiply(iArr7, secP192R1FieldElement6.f7543x, iArr7);
        }
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP192R1Point(this.curve, this.f7506x, this.f7507y.negate(), this.zs, this.withCompression);
    }
    ...
    public ECPoint twice() {
        ...
        ECCurve curve = getCurve();
        SecP192R1FieldElement secP192R1FieldElement = (SecP192R1FieldElement) this.f7507y;
        if (secP192R1FieldElement.isZero()) {
            return curve.getInfinity();
        }
        SecP192R1FieldElement secP192R1FieldElement2 = (SecP192R1FieldElement) this.f7506x;
        SecP192R1FieldElement secP192R1FieldElement3 = (SecP192R1FieldElement) this.zs[0];
        int[] iArrCreate = Nat192.create();
        int[] iArrCreate2 = Nat192.create();
        int[] iArrCreate3 = Nat192.create();
        SecP192R1Field.square(secP192R1FieldElement.f7543x, iArrCreate3);
        int[] iArrCreate4 = Nat192.create();
        SecP192R1Field.square(iArrCreate3, iArrCreate4);
        boolean zIsOne = secP192R1FieldElement3.isOne();
        int[] iArr = secP192R1FieldElement3.f7543x;
        if (!zIsOne) {
            SecP192R1Field.square(iArr, iArrCreate2);
            iArr = iArrCreate2;
        }
        SecP192R1Field.subtract(secP192R1FieldElement2.f7543x, iArr, iArrCreate);
        SecP192R1Field.add(secP192R1FieldElement2.f7543x, iArr, iArrCreate2);
        ...
        SecP192R1Field.square(iArrCreate2, secP192R1FieldElement4.f7543x);
        int[] iArr2 = secP192R1FieldElement4.f7543x;
        SecP192R1Field.subtract(iArr2, iArrCreate3, iArr2);
        int[] iArr3 = secP192R1FieldElement4.f7543x;
        ...
        SecP192R1Field.subtract(iArrCreate3, secP192R1FieldElement4.f7543x, secP192R1FieldElement5.f7543x);
        int[] iArr4 = secP192R1FieldElement5.f7543x;
        SecP192R1Field.multiply(iArr4, iArrCreate2, iArr4);
        int[] iArr5 = secP192R1FieldElement5.f7543x;
        ...
        SecP192R1Field.twice(secP192R1FieldElement.f7543x, secP192R1FieldElement6.f7543x);
        if (!zIsOne) {
            int[] iArr6 = secP192R1FieldElement6.f7543x;
            SecP192R1Field.multiply(iArr6, secP192R1FieldElement3.f7543x, iArr6);
        }
