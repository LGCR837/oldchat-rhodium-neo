...
public class SecT131R2Curve extends ECCurve.AbstractF2m {
    ...
    public SecT131R2Curve() {
        ...
        this.f7496a = fromBigInteger(new BigInteger(1, Hex.decode("03E5A88919D7CAFCBF415F07C2176573B2")));
        this.f7497b = fromBigInteger(new BigInteger(1, Hex.decode("04B8266A46C55657AC734CE38F018F2192")));
