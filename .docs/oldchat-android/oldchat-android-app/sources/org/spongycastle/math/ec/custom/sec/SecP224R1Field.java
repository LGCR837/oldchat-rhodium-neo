...
public class SecP224R1Field {
    ...
    private static final long f7549M = 4294967295L;
    private static final int P6 = -1;
    private static final int PExt13 = -1;

    /* JADX INFO: renamed from: P, reason: collision with root package name */
    static final int[] f7550P = {1, 0, 0, -1, -1, -1, -1};
    static final int[] PExt = {1, 0, 0, -2, -1, -1, 0, 2, 0, 0, -2, -1, -1, -1};
    private static final int[] PExtInv = {-1, -1, -1, 1, 0, 0, -1, -3, -1, -1, 1};

    public static void add(int[] iArr, int[] iArr2, int[] iArr3) {
        if (Nat224.add(iArr, iArr2, iArr3) != 0 || (iArr3[6] == -1 && Nat224.gte(iArr3, f7550P))) {
            addPInvTo(iArr3);
        }
    }
    ...
    public static void addOne(int[] iArr, int[] iArr2) {
        if (Nat.inc(7, iArr, iArr2) != 0 || (iArr2[6] == -1 && Nat224.gte(iArr2, f7550P))) {
            addPInvTo(iArr2);
        }
    }
    ...
    public static void half(int[] iArr, int[] iArr2) {
        if ((iArr[0] & 1) == 0) {
            ...
            Nat.shiftDownBit(7, iArr2, Nat224.add(iArr, f7550P, iArr2));
        }
    }
    ...
    public static void reduce(int[] iArr, int[] iArr2) {
        ...
        long j9 = (((long) iArr[0]) & 4294967295L) - j6;
        ...
        long j21 = j20 >> 32;
        if (j21 != 0) {
            long j22 = j21 + (((long) i2) & 4294967295L);
            iArr2[1] = (int) j22;
            long j23 = (j22 >> 32) + (4294967295L & ((long) i3));
            iArr2[2] = (int) j23;
            j19 += j23 >> 32;
        }
        iArr2[3] = (int) j19;
        if (((j19 >> 32) == 0 || Nat.incAt(7, iArr2, 4) == 0) && !(iArr2[6] == -1 && Nat224.gte(iArr2, f7550P))) {
            return;
        }
        addPInvTo(iArr2);
    }
    ...
    public static void reduce32(int i2, int[] iArr) {
        ...
        if ((j2 == 0 || Nat.incAt(7, iArr, 4) == 0) && !(iArr[6] == -1 && Nat224.gte(iArr, f7550P))) {
            return;
        }
        addPInvTo(iArr);
    }
    ...
    public static void twice(int[] iArr, int[] iArr2) {
        if (Nat.shiftUpBit(7, iArr, 0, iArr2) != 0 || (iArr2[6] == -1 && Nat224.gte(iArr2, f7550P))) {
            addPInvTo(iArr2);
        }
    }
}
