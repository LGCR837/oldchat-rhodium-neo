            ...
            if (iIntValue2 % 29 != 0 && iIntValue2 % 31 != 0 && iIntValue2 % 37 != 0 && iIntValue2 % 41 != 0 && iIntValue2 % 43 != 0) {
                ...
                if (iIntValue3 % 47 != 0 && iIntValue3 % 53 != 0 && iIntValue3 % 59 != 0 && iIntValue3 % 61 != 0 && iIntValue3 % 67 != 0) {
                    ...
                    if (iIntValue4 % 71 != 0 && iIntValue4 % 73 != 0 && iIntValue4 % 79 != 0 && iIntValue4 % 83 != 0) {
                        ...
                        if (iIntValue5 % 89 != 0 && iIntValue5 % 97 != 0 && iIntValue5 % ExtensionType.negotiated_ff_dhe_groups != 0 && iIntValue5 % 103 != 0) {
                            int iIntValue6 = bigInteger.mod(BigInteger.valueOf(167375713)).intValue();
                            if (iIntValue6 % CipherSuite.TLS_DHE_RSA_WITH_AES_256_CBC_SHA256 != 0 && iIntValue6 % CipherSuite.TLS_DH_anon_WITH_AES_256_CBC_SHA256 != 0 && iIntValue6 % 113 != 0 && iIntValue6 % CertificateBody.profileType != 0) {
    ...
    private static STOutput implSTRandomPrime(Digest digest, int i2, byte[] bArr) {
        ...
        if (i2 < 33) {
            ...
            do {
                ...
                inc(bArr, 1);
                i4++;
                long jExtract32 = ((long) (((extract32(bArr2) ^ extract32(bArr3)) & ((-1) >>> (32 - i2))) | (1 << (i2 - 1)) | 1)) & BodyPartID.bodyIdMax;
                if (isPrime32(jExtract32)) {
                    return new STOutput(BigInteger.valueOf(jExtract32), bArr, i4);
                }
            } while (i4 <= i2 * 4);
        ...
        BigInteger bigIntegerHashGen = hashGen(digest, primeSeed, i6);
        BigInteger bigInteger = ONE;
        BigInteger bit = bigIntegerHashGen.mod(bigInteger.shiftLeft(i5)).setBit(i5);
        ...
        while (true) {
            if (bigIntegerAdd.bitLength() > i2) {
                BigInteger bigInteger2 = ONE;
                bigIntegerShiftLeft2 = bigInteger2.shiftLeft(i5).subtract(bigInteger2).divide(bigIntegerShiftLeft).add(bigInteger2).shiftLeft(i3);
            ...
            if (implHasAnySmallFactors(bigIntegerAdd)) {
                ...
                BigInteger bigIntegerAdd2 = hashGen(digest, primeSeed, i6).mod(bigIntegerAdd.subtract(THREE)).add(TWO);
                BigInteger bigIntegerAdd3 = bigIntegerShiftLeft2.add(BigInteger.valueOf(i8));
