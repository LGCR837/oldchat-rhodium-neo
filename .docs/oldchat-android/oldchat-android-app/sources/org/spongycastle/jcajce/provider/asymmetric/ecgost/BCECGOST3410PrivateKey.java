...
public class BCECGOST3410PrivateKey implements ECPrivateKey, org.spongycastle.jce.interfaces.ECPrivateKey, PKCS12BagAttributeCarrier, ECPointEncoder {
    ...
    private transient BigInteger f7453d;
    ...
    private void populateFromPrivKeyInfo(PrivateKeyInfo privateKeyInfo) {
        ...
        if ((aSN1Primitive instanceof ASN1Sequence) && (ASN1Sequence.getInstance(aSN1Primitive).size() == 2 || ASN1Sequence.getInstance(aSN1Primitive).size() == 3)) {
            ...
            if (privateKey instanceof ASN1Integer) {
                this.f7453d = ASN1Integer.getInstance(privateKey).getPositiveValue();
                return;
            }
            ...
            this.f7453d = new BigInteger(1, bArr);
            return;
        }
    ...
    public byte[] getEncoded() {
        ...
        try {
            return new PrivateKeyInfo(new AlgorithmIdentifier(CryptoProObjectIdentifiers.gostR3410_2001, x962Parameters.toASN1Primitive()), (this.publicKey != null ? new org.spongycastle.asn1.sec.ECPrivateKey(orderBitLength, getS(), this.publicKey, x962Parameters) : new org.spongycastle.asn1.sec.ECPrivateKey(orderBitLength, getS(), x962Parameters)).toASN1Primitive()).getEncoded(ASN1Encoding.DER);
    ...
    public String toString() {
        return ECUtil.privateKeyToString(this.algorithm, this.f7453d, engineGetSpec());
    }

    public BCECGOST3410PrivateKey(ECPrivateKey eCPrivateKey) {
        this.algorithm = "ECGOST3410";
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.f7453d = eCPrivateKey.getS();
    ...
    public BCECGOST3410PrivateKey(ECPrivateKeySpec eCPrivateKeySpec) {
        this.algorithm = "ECGOST3410";
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.f7453d = eCPrivateKeySpec.getD();
    ...
    public BCECGOST3410PrivateKey(java.security.spec.ECPrivateKeySpec eCPrivateKeySpec) {
        this.algorithm = "ECGOST3410";
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.f7453d = eCPrivateKeySpec.getS();
    ...
    public BCECGOST3410PrivateKey(BCECGOST3410PrivateKey bCECGOST3410PrivateKey) {
        this.algorithm = "ECGOST3410";
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.f7453d = bCECGOST3410PrivateKey.f7453d;
    ...
    public BCECGOST3410PrivateKey(String str, ECPrivateKeyParameters eCPrivateKeyParameters, BCECGOST3410PublicKey bCECGOST3410PublicKey, ECParameterSpec eCParameterSpec) {
        ...
        this.algorithm = str;
        this.f7453d = eCPrivateKeyParameters.getD();
        if (eCParameterSpec == null) {
