...
public class BCECGOST3410_2012PrivateKey implements ECPrivateKey, org.spongycastle.jce.interfaces.ECPrivateKey, PKCS12BagAttributeCarrier, ECPointEncoder {
    ...
    private transient BigInteger f7454d;
    ...
    private void populateFromPrivKeyInfo(PrivateKeyInfo privateKeyInfo) {
        ...
        if ((aSN1Primitive instanceof ASN1Sequence) && (ASN1Sequence.getInstance(aSN1Primitive).size() == 2 || ASN1Sequence.getInstance(aSN1Primitive).size() == 3)) {
            ...
            if (privateKey instanceof ASN1Integer) {
                this.f7454d = ASN1Integer.getInstance(privateKey).getPositiveValue();
                return;
            }
            ...
            this.f7454d = new BigInteger(1, bArr);
            return;
        }
    ...
    public byte[] getEncoded() {
        ...
        int orderBitLength;
        boolean z2 = this.f7454d.bitLength() > 256;
        ASN1ObjectIdentifier aSN1ObjectIdentifier = z2 ? RosstandartObjectIdentifiers.id_tc26_gost_3410_12_512 : RosstandartObjectIdentifiers.id_tc26_gost_3410_12_256;
        int i2 = z2 ? 64 : 32;
        ...
        try {
            return new PrivateKeyInfo(new AlgorithmIdentifier(aSN1ObjectIdentifier, x962Parameters.toASN1Primitive()), (this.publicKey != null ? new org.spongycastle.asn1.sec.ECPrivateKey(orderBitLength, getS(), this.publicKey, x962Parameters) : new org.spongycastle.asn1.sec.ECPrivateKey(orderBitLength, getS(), x962Parameters)).toASN1Primitive()).getEncoded(ASN1Encoding.DER);
    ...
    public String toString() {
        return ECUtil.privateKeyToString(this.algorithm, this.f7454d, engineGetSpec());
    }

    public BCECGOST3410_2012PrivateKey(ECPrivateKey eCPrivateKey) {
        this.algorithm = "ECGOST3410-2012";
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.f7454d = eCPrivateKey.getS();
    ...
    public BCECGOST3410_2012PrivateKey(ECPrivateKeySpec eCPrivateKeySpec) {
        this.algorithm = "ECGOST3410-2012";
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.f7454d = eCPrivateKeySpec.getD();
    ...
    public BCECGOST3410_2012PrivateKey(java.security.spec.ECPrivateKeySpec eCPrivateKeySpec) {
        this.algorithm = "ECGOST3410-2012";
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.f7454d = eCPrivateKeySpec.getS();
    ...
    public BCECGOST3410_2012PrivateKey(BCECGOST3410_2012PrivateKey bCECGOST3410_2012PrivateKey) {
        this.algorithm = "ECGOST3410-2012";
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.f7454d = bCECGOST3410_2012PrivateKey.f7454d;
    ...
    public BCECGOST3410_2012PrivateKey(String str, ECPrivateKeyParameters eCPrivateKeyParameters, BCECGOST3410_2012PublicKey bCECGOST3410_2012PublicKey, ECParameterSpec eCParameterSpec) {
        ...
        this.algorithm = str;
        this.f7454d = eCPrivateKeyParameters.getD();
        if (eCParameterSpec == null) {
