...
public class BCDHPrivateKey implements DHPrivateKey, PKCS12BagAttributeCarrier {
    ...
    public BCDHPrivateKey(DHPrivateKey dHPrivateKey) {
        this.f7444x = dHPrivateKey.getX();
        this.dhSpec = dHPrivateKey.getParams();
    }

    public BCDHPrivateKey(DHPrivateKeySpec dHPrivateKeySpec) {
        this.f7444x = dHPrivateKeySpec.getX();
    ...
    public BCDHPrivateKey(PrivateKeyInfo privateKeyInfo) {
        ...
        this.f7444x = aSN1Integer.getValue();
    ...
    public BCDHPrivateKey(DHPrivateKeyParameters dHPrivateKeyParameters) {
        this.f7444x = dHPrivateKeyParameters.getX();
