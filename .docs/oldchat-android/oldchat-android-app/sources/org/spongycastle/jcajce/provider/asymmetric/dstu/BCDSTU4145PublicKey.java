...
public class BCDSTU4145PublicKey implements ECPublicKey, org.spongycastle.jce.interfaces.ECPublicKey, ECPointEncoder {
    ...
    public org.spongycastle.math.ec.ECPoint getQ() {
        org.spongycastle.math.ec.ECPoint q2 = this.ecPublicKey.getQ();
        return this.ecSpec == null ? q2.getDetachedPoint() : q2;
    }
    ...
    public ECPoint getW() {
        org.spongycastle.math.ec.ECPoint q2 = this.ecPublicKey.getQ();
        return new ECPoint(q2.getAffineXCoord().toBigInteger(), q2.getAffineYCoord().toBigInteger());
    }
