...
public class BCElGamalPublicKey implements ElGamalPublicKey, DHPublicKey {
    ...
    public byte[] getEncoded() {
        try {
            return new SubjectPublicKeyInfo(new AlgorithmIdentifier(OIWObjectIdentifiers.elGamalAlgorithm, new ElGamalParameter(this.elSpec.getP(), this.elSpec.getG())), new ASN1Integer(this.f7457y)).getEncoded(ASN1Encoding.DER);
    ...
    public BCElGamalPublicKey(DHPublicKeySpec dHPublicKeySpec) {
        this.f7457y = dHPublicKeySpec.getY();
    ...
    public BCElGamalPublicKey(ElGamalPublicKey elGamalPublicKey) {
        this.f7457y = elGamalPublicKey.getY();
        this.elSpec = elGamalPublicKey.getParameters();
    }

    public BCElGamalPublicKey(DHPublicKey dHPublicKey) {
        this.f7457y = dHPublicKey.getY();
    ...
    public BCElGamalPublicKey(ElGamalPublicKeyParameters elGamalPublicKeyParameters) {
        this.f7457y = elGamalPublicKeyParameters.getY();
    ...
    public BCElGamalPublicKey(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        try {
            this.f7457y = ((ASN1Integer) subjectPublicKeyInfo.parsePublicKey()).getValue();
