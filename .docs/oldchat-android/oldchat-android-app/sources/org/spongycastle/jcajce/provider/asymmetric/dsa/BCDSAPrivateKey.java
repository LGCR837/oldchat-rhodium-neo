...
public class BCDSAPrivateKey implements DSAPrivateKey, PKCS12BagAttributeCarrier {
    ...
    public String toString() {
        ...
        BigInteger bigIntegerModPow = getParams().getG().modPow(this.f7449x, getParams().getP());
    ...
    public BCDSAPrivateKey(DSAPrivateKey dSAPrivateKey) {
        this.f7449x = dSAPrivateKey.getX();
        this.dsaSpec = dSAPrivateKey.getParams();
    }

    public BCDSAPrivateKey(DSAPrivateKeySpec dSAPrivateKeySpec) {
        this.f7449x = dSAPrivateKeySpec.getX();
    ...
    public BCDSAPrivateKey(PrivateKeyInfo privateKeyInfo) {
        ...
        this.f7449x = ((ASN1Integer) privateKeyInfo.parsePrivateKey()).getValue();
    ...
    public BCDSAPrivateKey(DSAPrivateKeyParameters dSAPrivateKeyParameters) {
        this.f7449x = dSAPrivateKeyParameters.getX();
