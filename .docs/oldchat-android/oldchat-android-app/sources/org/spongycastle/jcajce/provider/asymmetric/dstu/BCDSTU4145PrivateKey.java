...
public class BCDSTU4145PrivateKey implements ECPrivateKey, org.spongycastle.jce.interfaces.ECPrivateKey, PKCS12BagAttributeCarrier, ECPointEncoder {
    ...
    private transient BigInteger f7451d;
    ...
    public byte[] getEncoded() {
        ...
        org.spongycastle.asn1.sec.ECPrivateKey eCPrivateKey = this.publicKey != null ? new org.spongycastle.asn1.sec.ECPrivateKey(orderBitLength, getS(), this.publicKey, x962Parameters) : new org.spongycastle.asn1.sec.ECPrivateKey(orderBitLength, getS(), x962Parameters);
        try {
    ...
    public String toString() {
        return ECUtil.privateKeyToString(this.algorithm, this.f7451d, engineGetSpec());
    }

    public BCDSTU4145PrivateKey(ECPrivateKey eCPrivateKey) {
        this.algorithm = "DSTU4145";
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.f7451d = eCPrivateKey.getS();
    ...
    public BCDSTU4145PrivateKey(ECPrivateKeySpec eCPrivateKeySpec) {
        this.algorithm = "DSTU4145";
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.f7451d = eCPrivateKeySpec.getD();
    ...
    public BCDSTU4145PrivateKey(java.security.spec.ECPrivateKeySpec eCPrivateKeySpec) {
        this.algorithm = "DSTU4145";
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.f7451d = eCPrivateKeySpec.getS();
    ...
    public BCDSTU4145PrivateKey(BCDSTU4145PrivateKey bCDSTU4145PrivateKey) {
        this.algorithm = "DSTU4145";
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.f7451d = bCDSTU4145PrivateKey.f7451d;
    ...
    public BCDSTU4145PrivateKey(String str, ECPrivateKeyParameters eCPrivateKeyParameters, BCDSTU4145PublicKey bCDSTU4145PublicKey, ECParameterSpec eCParameterSpec) {
        ...
        this.algorithm = str;
        this.f7451d = eCPrivateKeyParameters.getD();
        if (eCParameterSpec == null) {
