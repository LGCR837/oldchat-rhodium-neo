...
public class X509CRLObject extends X509CRL {
    ...
    private CertificateList f7474c;
    ...
    private void doVerify(PublicKey publicKey, Signature signature) throws SignatureException, InvalidKeyException, CRLException {
        if (!this.f7474c.getSignatureAlgorithm().equals(this.f7474c.getTBSCertList().getSignature())) {
    ...
    private Set getExtensionOIDs(boolean z2) {
        ...
        if (getVersion() != 2 || (extensions = this.f7474c.getTBSCertList().getExtensions()) == null) {
            return null;
        }
    ...
    private Set loadCRLEntries() {
        Extension extension;
        HashSet hashSet = new HashSet();
        Enumeration revokedCertificateEnumeration = this.f7474c.getRevokedCertificateEnumeration();
    ...
    public boolean equals(Object obj) {
        ...
        return this.f7474c.equals(x509CRLObject.f7474c);
    }
    ...
    public byte[] getEncoded() throws CRLException {
        try {
            return this.f7474c.getEncoded(ASN1Encoding.DER);
    ...
    public byte[] getExtensionValue(String str) {
        Extension extension;
        Extensions extensions = this.f7474c.getTBSCertList().getExtensions();
    ...
    public Principal getIssuerDN() {
        return new X509Principal(X500Name.getInstance(this.f7474c.getIssuer().toASN1Primitive()));
    }

    @Override // java.security.cert.X509CRL
    public X500Principal getIssuerX500Principal() {
        try {
            return new X500Principal(this.f7474c.getIssuer().getEncoded());
    ...
    public Date getNextUpdate() {
        if (this.f7474c.getNextUpdate() != null) {
            return this.f7474c.getNextUpdate().getDate();
        }
        return null;
    }
    ...
    public String getSigAlgOID() {
        return this.f7474c.getSignatureAlgorithm().getAlgorithm().getId();
    }
    ...
    public byte[] getSignature() {
        return this.f7474c.getSignature().getOctets();
    }

    @Override // java.security.cert.X509CRL
    public byte[] getTBSCertList() throws CRLException {
        try {
            return this.f7474c.getTBSCertList().getEncoded(ASN1Encoding.DER);
        } catch (IOException e2) {
            throw new CRLException(e2.toString());
        }
    }
    ...
    public Date getThisUpdate() {
        return this.f7474c.getThisUpdate().getDate();
    }

    @Override // java.security.cert.X509CRL
    public int getVersion() {
        return this.f7474c.getVersionNumber();
    }
    ...
    public boolean isRevoked(Certificate certificate) {
        ...
        Enumeration revokedCertificateEnumeration = this.f7474c.getRevokedCertificateEnumeration();
        X500Name issuer2 = this.f7474c.getIssuer();
