...
public class JDKDSAPublicKey implements DSAPublicKey {
    ...
    private BigInteger f7470y;

    public JDKDSAPublicKey(DSAPublicKeySpec dSAPublicKeySpec) {
        this.f7470y = dSAPublicKeySpec.getY();
    ...
    private void readObject(ObjectInputStream objectInputStream) {
        this.f7470y = (BigInteger) objectInputStream.readObject();
        this.dsaSpec = new DSAParameterSpec((BigInteger) objectInputStream.readObject(), (BigInteger) objectInputStream.readObject(), (BigInteger) objectInputStream.readObject());
    }

    private void writeObject(ObjectOutputStream objectOutputStream) throws IOException {
        objectOutputStream.writeObject(this.f7470y);
    ...
    public byte[] getEncoded() {
        try {
            ...
            return dSAParams == null ? new SubjectPublicKeyInfo(new AlgorithmIdentifier(X9ObjectIdentifiers.id_dsa), new ASN1Integer(this.f7470y)).getEncoded(ASN1Encoding.DER) : new SubjectPublicKeyInfo(new AlgorithmIdentifier(X9ObjectIdentifiers.id_dsa, new DSAParameter(dSAParams.getP(), this.dsaSpec.getQ(), this.dsaSpec.getG())), new ASN1Integer(this.f7470y)).getEncoded(ASN1Encoding.DER);
    ...
    public JDKDSAPublicKey(BigInteger bigInteger, DSAParameterSpec dSAParameterSpec) {
        this.f7470y = bigInteger;
        this.dsaSpec = dSAParameterSpec;
    }

    public JDKDSAPublicKey(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        try {
            this.f7470y = ((ASN1Integer) subjectPublicKeyInfo.parsePublicKey()).getValue();
