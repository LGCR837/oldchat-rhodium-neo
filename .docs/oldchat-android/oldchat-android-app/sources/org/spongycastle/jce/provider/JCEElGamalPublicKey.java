...
public class JCEElGamalPublicKey implements ElGamalPublicKey, DHPublicKey {
    ...
    public byte[] getEncoded() {
        return KeyUtil.getEncodedSubjectPublicKeyInfo(new AlgorithmIdentifier(OIWObjectIdentifiers.elGamalAlgorithm, new ElGamalParameter(this.elSpec.getP(), this.elSpec.getG())), new ASN1Integer(this.f7468y));
    }
    ...
    public JCEElGamalPublicKey(ElGamalPublicKeyParameters elGamalPublicKeyParameters) {
        this.f7468y = elGamalPublicKeyParameters.getY();
    ...
    public JCEElGamalPublicKey(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        try {
            this.f7468y = ((ASN1Integer) subjectPublicKeyInfo.parsePublicKey()).getValue();
