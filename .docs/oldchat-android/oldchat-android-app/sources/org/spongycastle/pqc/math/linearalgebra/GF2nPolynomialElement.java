    ...
    private void reduceThis() {
        ...
        if (((GF2nPolynomialField) this.mField).isTrinomial()) {
            try {
                ...
                if (this.mDegree - tc > 32) {
                    ...
                    int i3 = this.mDegree;
                    if (length2 <= (i3 << 1)) {
                        this.polynomial.reduceTrinomial(i3, tc);
                        return;
                    }
                }
        ...
        try {
            ...
            if (this.mDegree - pc[2] > 32) {
                ...
                int i4 = this.mDegree;
                if (length3 <= (i4 << 1)) {
                    this.polynomial.reducePentanomial(i4, pc);
                    return;
                }
            }
    ...
    public void squareThisMatrix() {
        ...
        while (true) {
            if (i2 >= this.mDegree) {
                ...
                if (this.polynomial.vectorMult(((GF2nPolynomialField) this.mField).squaringMatrix[(r2 - i2) - 1])) {
