...
public class McElieceCipher implements MessageEncryptor {
    ...
    private GF2Vector computeMessageRepresentative(byte[] bArr) {
        byte[] bArr2 = new byte[this.maxPlainTextSize + ((this.f7623k & 7) != 0 ? 1 : 0)];
        System.arraycopy(bArr, 0, bArr2, 0, bArr.length);
        bArr2[bArr.length] = 1;
        return GF2Vector.OS2VP(this.f7623k, bArr2);
    }

    private void initCipherDecrypt(McEliecePrivateKeyParameters mcEliecePrivateKeyParameters) {
        this.f7624n = mcEliecePrivateKeyParameters.getN();
        int k2 = mcEliecePrivateKeyParameters.getK();
        this.f7623k = k2;
        this.maxPlainTextSize = k2 >> 3;
        this.cipherTextSize = this.f7624n >> 3;
    }
    ...
    private void initCipherEncrypt(McEliecePublicKeyParameters mcEliecePublicKeyParameters) {
        ...
        this.f7624n = mcEliecePublicKeyParameters.getN();
        this.f7623k = mcEliecePublicKeyParameters.getK();
        this.f7625t = mcEliecePublicKeyParameters.getT();
        this.cipherTextSize = this.f7624n >> 3;
        this.maxPlainTextSize = this.f7623k >> 3;
    }
    ...
    public byte[] messageDecrypt(byte[] bArr) {
        ...
        GF2Vector gF2VectorOS2VP = GF2Vector.OS2VP(this.f7624n, bArr);
        ...
        return computeMessage((GF2Vector) sInv.leftMultiply(gF2Vector2.extractRightVector(this.f7623k)));
    }
    ...
    public byte[] messageEncrypt(byte[] bArr) {
        ...
        return ((GF2Vector) ((McEliecePublicKeyParameters) this.key).getG().leftMultiply(gF2VectorComputeMessageRepresentative).add(new GF2Vector(this.f7624n, this.f7625t, this.sr))).getEncoded();
    }
}
