...
public class McEliecePointchevalCipher implements MessageEncryptor {
    ...
    private void initCipherDecrypt(McElieceCCA2PrivateKeyParameters mcElieceCCA2PrivateKeyParameters) {
        ...
        this.f7639n = mcElieceCCA2PrivateKeyParameters.getN();
        this.f7638k = mcElieceCCA2PrivateKeyParameters.getK();
        this.f7640t = mcElieceCCA2PrivateKeyParameters.getT();
    }
    ...
    private void initCipherEncrypt(McElieceCCA2PublicKeyParameters mcElieceCCA2PublicKeyParameters) {
        ...
        this.f7639n = mcElieceCCA2PublicKeyParameters.getN();
        this.f7638k = mcElieceCCA2PublicKeyParameters.getK();
        this.f7640t = mcElieceCCA2PublicKeyParameters.getT();
    }

    public int decryptOutputSize(int i2) {
        return 0;
    }

    public int encryptOutputSize(int i2) {
        return 0;
    }
    ...
    public byte[] messageDecrypt(byte[] bArr) throws InvalidCipherTextException {
        ...
        int i2 = (this.f7639n + 7) >> 3;
        int length = bArr.length - i2;
        byte[][] bArrSplit = ByteUtils.split(bArr, i2);
        byte[] bArr2 = bArrSplit[0];
        byte[] bArr3 = bArrSplit[1];
        GF2Vector[] gF2VectorArrDecryptionPrimitive = McElieceCCA2Primitives.decryptionPrimitive((McElieceCCA2PrivateKeyParameters) this.key, GF2Vector.OS2VP(this.f7639n, bArr2));
        ...
        if (Conversions.encode(this.f7639n, this.f7640t, bArr5).equals(gF2Vector)) {
            return ByteUtils.split(bArr4, length - (this.f7638k >> 3))[0];
        }
    ...
    public byte[] messageEncrypt(byte[] bArr) {
        ...
        int i2 = this.f7638k >> 3;
        byte[] bArr2 = new byte[i2];
        this.sr.nextBytes(bArr2);
        GF2Vector gF2Vector = new GF2Vector(this.f7638k, this.sr);
        ...
        byte[] encoded2 = McElieceCCA2Primitives.encryptionPrimitive((McElieceCCA2PublicKeyParameters) this.key, gF2Vector, Conversions.encode(this.f7639n, this.f7640t, bArr3)).getEncoded();
        DigestRandomGenerator digestRandomGenerator = new DigestRandomGenerator(new SHA1Digest());
        digestRandomGenerator.addSeedMaterial(encoded);
