...
public class Treehash {
    ...
    public Treehash(Digest digest, byte[][] bArr, int[] iArr) {
        ...
        for (int i3 = 0; i3 < this.tailLength; i3++) {
            this.tailStack.addElement(bArr[i3 + 3]);
        }
    }
    ...
    public int[] getStatInt() {
        ...
        for (int i3 = 0; i3 < this.tailLength; i3++) {
            iArr[i3 + 6] = ((Integer) this.heightOfNodes.elementAt(i3)).intValue();
        }
        return iArr;
    }
    ...
    public String toString() {
        ...
        for (int i3 = 0; i3 < this.tailLength + 3; i3++) {
            str = getStatByte()[i3] != null ? str + new String(Hex.encode(getStatByte()[i3])) + " " : str + "null ";
        }
    ...
    public void update(GMSSRandom gMSSRandom, byte[] bArr) {
        ...
        if (this.firstNode == null) {
            ...
            int i2 = 0;
            while (this.tailLength > 0 && i2 == ((Integer) this.heightOfNodes.lastElement()).intValue()) {
