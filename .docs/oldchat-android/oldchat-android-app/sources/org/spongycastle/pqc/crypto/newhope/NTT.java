...
class NTT {
        ...
        for (int i2 = 0; i2 < 10; i2 += 2) {
            ...
            for (int i4 = 0; i4 < i3; i4++) {
                ...
                while (i5 < 1023) {
                    ...
                    short s2 = sArr2[i6];
                    sArr[i5] = (short) (i7 + i9);
                    sArr[i8] = Reduce.montgomery(s2 * ((i7 + 36867) - i9));
                    i5 += i3 * 2;
                    i6 = i10;
                }
            }
            ...
            for (int i12 = 0; i12 < i11; i12++) {
                ...
                while (i13 < 1023) {
                    ...
                    int i18 = i14 + 1;
                    short s3 = sArr2[i14];
                    sArr[i13] = Reduce.barrett((short) (i15 + i17));
                    sArr[i16] = Reduce.montgomery(s3 * ((i15 + 36867) - i17));
                    i13 += i11 * 2;
                    i14 = i18;
                }
            }
    ...
    public static void mulCoefficients(short[] sArr, short[] sArr2) {
        for (int i2 = 0; i2 < 1024; i2++) {
            sArr[i2] = Reduce.montgomery((sArr[i2] & 65535) * (65535 & sArr2[i2]));
        }
    }
}
