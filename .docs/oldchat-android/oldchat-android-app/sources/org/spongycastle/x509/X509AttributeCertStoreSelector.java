                ...
                if (!this.targetNames.isEmpty()) {
                    ...
                    for (Targets targets : targetsObjects) {
                        ...
                        while (true) {
                            ...
                            if (this.targetNames.contains(GeneralName.getInstance(targets2[i2].getTargetName()))) {
                                z2 = true;
                                break;
                            }
                            i2++;
            ...
            if (!this.targetGroups.isEmpty()) {
                ...
                for (Targets targets3 : targetsObjects) {
                    ...
                    while (true) {
                        ...
                        if (this.targetGroups.contains(GeneralName.getInstance(targets4[i3].getTargetGroup()))) {
                            z3 = true;
                            break;
                        }
                        i3++;
