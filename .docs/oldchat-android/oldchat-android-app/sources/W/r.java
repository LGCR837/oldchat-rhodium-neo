...
public abstract class r {
    ...
    public static String a(String str) throws H.j {
        ...
        for (Object[] objArr : f595b) {
            if (objArr[0].equals(strSubstring)) {
                Object obj = objArr[1];
                return obj == f594a ? c(2, ((Integer) objArr[2]).intValue(), str) : b(2, ((Integer) obj).intValue(), str);
            }
        }
        if (str.length() < 3) {
            throw H.j.a();
        ...
        for (Object[] objArr2 : f596c) {
            if (objArr2[0].equals(strSubstring2)) {
                Object obj2 = objArr2[1];
                return obj2 == f594a ? c(3, ((Integer) objArr2[2]).intValue(), str) : b(3, ((Integer) obj2).intValue(), str);
            }
        }
        for (Object[] objArr3 : f597d) {
            if (objArr3[0].equals(strSubstring2)) {
                Object obj3 = objArr3[1];
                return obj3 == f594a ? c(4, ((Integer) objArr3[2]).intValue(), str) : b(4, ((Integer) obj3).intValue(), str);
            }
        }
        if (str.length() < 4) {
            throw H.j.a();
        ...
        for (Object[] objArr4 : f598e) {
            if (objArr4[0].equals(strSubstring3)) {
                Object obj4 = objArr4[1];
                return obj4 == f594a ? c(4, ((Integer) objArr4[2]).intValue(), str) : b(4, ((Integer) obj4).intValue(), str);
            }
        }
        throw H.j.a();
    }

    public static String b(int i2, int i3, String str) throws H.j {
        if (str.length() < i2) {
            throw H.j.a();
        }
    ...
    public static String c(int i2, int i3, String str) throws H.j {
        String strSubstring = str.substring(0, i2);
        int length = i3 + i2;
